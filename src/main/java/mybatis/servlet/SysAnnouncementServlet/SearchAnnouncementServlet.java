...
public class SearchAnnouncementServlet extends HttpServlet implements Constant {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<SysAnnouncement> sysAnnouncementList=sysAnnouncementService.searchAnnouncement(search);
