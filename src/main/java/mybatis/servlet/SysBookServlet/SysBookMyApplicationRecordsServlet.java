...
public class SysBookMyApplicationRecordsServlet extends HttpServlet  {
	/**
	 * 我申请
	 * 的图书
	 */
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<SysBook> booklist=impl.selectMyAppRec(account, pageSize, start);
		...
		jsonObject.put("myaplication", booklist);
