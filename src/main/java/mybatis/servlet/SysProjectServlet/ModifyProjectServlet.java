...
public class ModifyProjectServlet extends HttpServlet implements Constants {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        sysProject.setId(Integer.parseInt(projectIDStr.trim()));
        ...
        boolean updateResult=sysProjectService.modifyProjectByID(sysProject);
