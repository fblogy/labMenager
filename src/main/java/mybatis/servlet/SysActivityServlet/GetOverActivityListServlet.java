...
public class GetOverActivityListServlet extends HttpServlet implements Constants {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<SysActivity> sysActivityList=sysActivityService.getOverActivityList();
        /**
