...
public class SysSupplyServiceImpl extends BaseMapper implements SysSupplyService {
	...
	public List<Map<String, Object>> selectByPartSupplyName(String word,int s,int p) {
		// TODO Auto-generated method stub
		SqlSession ses=this.getSqlSession();
...
//		ses.commit();
	...
	public List<SysSupply> selectMyAppRecByWord(String account, int p, int s, String word) {
		// TODO Auto-generated method stub
	...
	public List<SysSupply> selectMyAppRec(String account, int p, int s) {
		// TODO Auto-generated method stub
		SqlSession ses=this.getSqlSession();
	...
	public List<SysSupply> selectAllAppRecByWord(int p, int s, String word) {
		// TODO Auto-generated method stub
		SqlSession ses=this.getSqlSession();

		SysSupplyMapper supplyMapper=ses.getMapper(SysSupplyMapper.class);
		List<SysSupply> list= supplyMapper.allAppRecByWord(s, p,"%"+word+"%");
	...
	public List<SysSupply> selectAllAppRec(int p, int s) {
		// TODO Auto-generated method stub
		SqlSession ses=this.getSqlSession();
	...
	public List<Map<String, Object>> selectAllBorrowByWord(int p, int s, String word) {
		// TODO Auto-generated method stub
		SqlSession ses=this.getSqlSession();
	...
	public List<Map<String, Object>> selectMyBorrowByWords(String account, int p, int s, String word) {
		// TODO Auto-generated method stub
		SqlSession ses=this.getSqlSession();
