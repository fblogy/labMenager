...
public interface SysSupplyService {
	...
	// 个人端模糊搜索物资申请清单
	List<SysSupply> selectMyAppRecByWord(String account, int p, int s, String word);

	// 个人端物资申请清单的数量
	int countMyAppRec(String account);

	// 个人端物资申请清单
	List<SysSupply> selectMyAppRec(String account, int p, int s);

	// 管理员端模糊搜索物资申请清单的数量
	int countAllAppRecByWord(String word);

	// 管理员端模糊搜索物资申请清单
	List<SysSupply> selectAllAppRecByWord(int p, int s, String word);

	// 管理员端物资申请清单的数量
	int countAllAppRec();

	// 管理员端物资申请清单
	List<SysSupply> selectAllAppRec(int p, int s);
	...
	// 物资模糊搜索
	List<Map<String, Object>> selectByPartSupplyName(String name, int s, int p);
